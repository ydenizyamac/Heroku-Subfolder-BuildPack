...
2. `heroku buildpacks:set https://github.com/ydenizyamac/Heroku-Subfolder-BuildPack`
3. `heroku buildpacks:add heroku/nodejs` or whatever buildpack you need for your application
4. `heroku config:set PROJECT_PATH=projects/webservice` pointing to what you want to be a project root.
